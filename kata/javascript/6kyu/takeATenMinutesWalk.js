 ...
 * with a Walk Generating App on their phones -- everytime you press the
 * button it sends you an array of one-letter strings representing directions
 * to walk (eg. ['n', 's', 'w', 'e']). You always walk only a single block for
 * each letter (direction) and you know it takes you one minute to traverse one
