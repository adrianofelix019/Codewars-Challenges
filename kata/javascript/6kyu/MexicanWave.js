 ...
 * their arms. Immediately upon stretching to full height, the spectator
...
function wave(str) {
    ...
    for (let i = 0;i < str.length;i++) {
        ...
        let newWord = ''
        newWord = str.substr(0, i) + str[i].toUpperCase() + str.substr(i+1, str.length)
        waveArray.push(newWord)
    }
