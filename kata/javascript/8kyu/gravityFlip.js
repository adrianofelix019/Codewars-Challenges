 ...
 * cubes downwards. When Bob switches the gravity, it begins to pull all the cubes
...
const comparation = (a, b) => a > b ? 1 : -1

function flip(d, a) {
  return d === 'R' ? a.sort(comparation)
  : a.sort(comparation).reverse()
}
