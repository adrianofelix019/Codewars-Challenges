...
either '1' or '0' based on the fact whether the Nth letter of the
...
of times), set the first character of the output string to '1', otherwise to
'0'. if 'b' or 'B' appears in the string, set the second character to
